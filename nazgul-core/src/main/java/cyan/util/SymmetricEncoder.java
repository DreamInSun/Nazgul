...
public class SymmetricEncoder {
    ...
    public static String AESDecode(String encodeRules, String content) {
        try {
            ...
            //TODO this is a BUG when running in Linux @see http://blog.csdn.net/hj_zrj/article/details/46047365
    ...
    public static String[] decode(String[] strArr) {
        if (strArr.length < 2) return null;
        String[] retArr = new String[strArr.length];
        String k = AESDecode(g_key, strArr[0]);
        for (int i = 1; i < strArr.length; i++) {
            retArr[i] = AESDecode(k, strArr[i]);
        }
        return retArr;
    }
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        String[] encoded = SymmetricEncoder.encode(testArr);
        System.out.println(encoded);
        String[] decoded = SymmetricEncoder.decode(encoded);
