...
import cyan.nazgul.dropwizard.auth.multiauth.MultiAuthSecurityContext;
...
public class JwtAuthFilter<P extends Principal> extends MultiAuthFilter<JwtContext, P> {
