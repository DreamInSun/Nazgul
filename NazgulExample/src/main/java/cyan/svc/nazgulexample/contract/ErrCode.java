...
public class ErrCode {
    ...
    public static final int ROUTE_MAPPING_PERSISTANCE_ERROR = ROUTE_MAPPING_BASE + 11;
    ...
    public static final ErrInfoMapper g_errInfoMapper = (new ErrInfoMapper())
            ...
            .put(ErrCode.ROUTE_MAPPING_PERSISTANCE_ERROR, "ROUTE_MAPPING_PERSISTANCE_ERROR")
