...
// Source File Name:   PsiXmlAttributeReference.java
...
public class PsiXmlAttributeReference
...
_L1:
		JVM INSTR dup ;
		0;
		"com/ccnode/codegenerator/reference/PsiXmlAttributeReference";
		JVM INSTR aastore ;
		  goto _L3
_L2:
		JVM INSTR dup ;
...
_L10:
		JVM INSTR new #111 <Class IllegalStateException>;
		JVM INSTR dup_x1 ;
		JVM INSTR swap ;
		IllegalStateException();
		  goto _L12
_L11:
		JVM INSTR new #115 <Class IllegalArgumentException>;
		JVM INSTR dup_x1 ;
		JVM INSTR swap ;
