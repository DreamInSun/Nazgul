...
// Source File Name:   ChooseParsedResultToUseDialog.java
...
public class ChooseParsedResultToUseDialog extends DialogWrapper
{
	...
	public ChooseParsedResultToUseDialog(Project project, java.util.List tags)
	{
		super(project, true);
	...
	protected JComponent createCenterPanel()
	{
		...
		for (int i = 0; i < xmlTagAndInfos.size(); i++)
		{
			...
			JTextArea comp = new JTextArea((String)xmlTagAndInfos.get(i));
			...
			jRadioButton.addActionListener(new ActionListener() {
				...
				final ChooseParsedResultToUseDialog this$0;
			...
			{
				this.this$0 = ChooseParsedResultToUseDialog.this;
				super();
			}
			});
